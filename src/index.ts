 ...
 * }
 */
async function discoverWristbandAuth(authConfig: AuthConfig): Promise<WristbandAuth> {
...
export { createWristbandAuth, discoverWristbandAuth, CallbackResultType, WristbandError, InvalidGrantError };
