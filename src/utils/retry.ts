...
import { MAX_API_RETRY_ATTEMPTS, API_RETRY_DELAY_MS } from './constants';
 ...
 * {@link MAX_API_RETRY_ATTEMPTS} times with a fixed delay between attempts, but only for
 * retryable errors (5xx responses, missing responses, or non-FetchErrors such as network
 * failures). Non-retryable errors (4xx responses) are re-thrown immediately without retrying.
 *
